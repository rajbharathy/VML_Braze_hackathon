...
function loadKnowledge() {
  const files = ['best-practice.md', 'client-context.md', 'ecosystem-architecture.md', 'braze-api-reference.md', 'canvas-brief.md', 'canvas-metrics-module.md', 'housekeeping-module.md', 'workspace-health-module.md', 'unused-attributes.md', 'unused-segments.md', 'migration-audit-module.md'];
  return files.map(f => {
    try {
